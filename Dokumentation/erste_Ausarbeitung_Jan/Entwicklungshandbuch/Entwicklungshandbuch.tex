...
\section{Activities}
\subsection{NewsActivity.java}\label{newsactitvity}
\begin{itemize}
...
\subsection{EinstellungsActivity.java}
...
\section{NewsClickedActivity.java}
...
\subsection{Klasse DetailHelper}
...
\item[Überschriebene Funktionen]~\par
\ \\[1em]
\item[OnAttach()]~\par
\begin{itemize}
...
\item[standalone-Funktionen]~\par
\  \\[1em]
\item[isOnline()]~\par
\begin{itemize}
...
\end{itemize}
\newpage
\subsection{NavigationDrawerFragment}\label{NavigationDrawerFragment}
\begin{itemize}
...
\subsection{StundenplanFragment}
...
\subsection{CustomAdapterNews.java}
...
\subsection{CustomAdapterNoten.java}
...
\end{lstlisting}
\newpage
\subsection{CustomAdapterStundenplan}
...
\subsection{activity\_news\_clicked.xml}
...
\subsection{settings\_toolbar}
Definiert die Kopfzeile der einstellung.xml.

\subsection{impressum.xml \& activity\_impressum}
...
\end{itemize}
\newpage
\section{Erweiterungen und Verbesserungen für kommende Versionen}
...
\subsection{Pflege der array.xml}\label{pflege}
...
\subsection{Portierung auf andere Systeme}
...
\subsection{Unterstützung von Tabletts}
