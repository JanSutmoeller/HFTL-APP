...
morekeywords={public, class, long, return, int, private, import, final, extends, static, if, else, null, void, super, while, new, boolean, protected, default, switch, break, try, catch, for, package},
keywordstyle=\color{darkblue},
morestring=[s]{"}{"},
identifierstyle=\color{schwarz},
stringstyle=\color{gruen},
basicstyle=\ttfamily\footnotesize,
emph={inflater, tv_date, tv_name, context, name, namelist_name, tv_mark, magenta, gruen, gelb, tv_semester, GONE, TERMINDETAIL, notenList, semesterList, fachList, versuchList, newsResolver, intent, datum, tv_category, grau01, dunkelblau, kategorie},
emphstyle=\color{lila},
belowcaptionskip=1\baselineskip,
breaklines=true,
showstringspaces=false,
...
\cleardoublepage\pdfbookmark{Inhaltsverzeichniss}{toc} %Inhaltsverzeichnis im PDF
...
\newpage
\input{03_Bedienungsanleitung/Bedienungsanleitung}
\input{04_Anhang/Anhang}
